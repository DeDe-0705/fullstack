...
import { submitOrderThunk } from './orderSlice'
    ...
    return (
      <Card title="下单成功（Redux fulfilled 状态）">
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <br />
          <Typography.Text strong>实付：¥{currentOrder.totalPrice}</Typography.Text>
        </div>
        <Link to="/shop"><Button style={{ marginTop: 16 }}>继续购物</Button></Link>
      </Card>
    )
  }
