...
export class ConversationController {
  ...
  @Post('conversations/:id/edit')
  editConversation (@Param('id') id: string, @Body() body: UpdateConversationDto) {
    return this.conversationService.editConversation(id, body.userId, body.title);
  }
